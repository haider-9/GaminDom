...
const Header = () => {
  ...
  const iconProps = {
    size: 24,
    className:
      "text-muted hover:text-secondary transition-colors duration-200",
  };
      ...
      <div className="md:hidden">
        ...
        <div className="w-full" onClick={() => setIsSearchOpen(true)}>
          <div className="relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-muted pointer-events-none" />
            <input
              type="text"
              placeholder="Search games..."
              className="w-full pl-10 pr-16 py-3 bg-surface text-primary placeholder-muted rounded-full focus:outline-none cursor-pointer transition-all duration-200 hover:bg-surface-hover"
              aria-label="Search"
              readOnly
            />
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center space-x-1">
              <kbd className="hidden sm:flex px-2 py-1  text-xs text-text-inverse dark:text-muted bg-surface/50 rounded border border-border items-center">
        ...
        <div className="flex-1 max-w-md mx-8 flex items-center justify-between">
          ...
          >
            ...
            <input
              type="text"
              placeholder="Search games..."
              className="w-full pl-10 pr-20 py-2 bg-surface text-primary placeholder-muted rounded-full focus:outline-none cursor-pointer transition-all duration-200 hover:bg-surface-hover"
              aria-label="Search"
              readOnly
            />
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center space-x-1">
              <kbd className="px-2 py-1 text-xs text-text-inverse dark:text-muted bg-surface/50 rounded border border-border">
          ...
          <div className="px-6 pb-4 ">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-surface text-primary placeholder-muted rounded-full border border-primary focus:outline-none"
                aria-label="Search"
                autoFocus
              />
            </div>
