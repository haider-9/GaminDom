...
const SettingsPage = () => {
  ...
  const handleReset = () => {
    // Reset theme and accent color through context
    setTheme("dark");
    setAccentColor("red");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
            ...
            <div className="flex items-center gap-4">
              {hasChanges && (
                ...
                >
                  <button
                    onClick={handleReset}
                    className="flex items-center gap-2 px-4 py-2 bg-black/30 hover:bg-black/40 text-white/70 hover:text-white rounded-2xl transition-colors"
                  >
                    <RotateCcw size={16} />
                    Reset
                  </button>
                  <button
                    onClick={handleSave}
                    disabled={loading}
                    className="flex items-center gap-2 px-6 py-2 bg-[#bb3b3b] hover:bg-[#bb3b3b]/80 text-white rounded-2xl transition-colors disabled:opacity-50"
                  >
                    {loading ? (
          ...
          <div className="bg-black/50 rounded-3xl p-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-gradient-to-br from-[#bb3b3b] to-[#bb3b3b]/60 rounded-2xl flex items-center justify-center">
                <Settings size={32} className="text-white" />
              </div>
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">Settings</h1>
                <p className="text-white/70">Customize your Gamindom experience</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-black/50 rounded-3xl p-6 sticky top-6">
            ...
            <div className="bg-black/50 rounded-3xl p-8">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="relative">
                        <User size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#bb3b3b]" />
                        <input
                          type="text"
                          value={settings.username}
                          onChange={(e) => handleSettingChange("username", e.target.value)}
                          className="w-full bg-black/30 border border-white/20 rounded-2xl pl-10 pr-4 py-3 text-white placeholder-white/50 focus:border-[#bb3b3b] focus:outline-none transition-colors"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black/30 border border-white/20 rounded-2xl px-4 py-3 text-white placeholder-white/50 focus:border-[#bb3b3b] focus:outline-none transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full bg-black/30 border border-white/20 rounded-2xl px-4 py-3 text-white placeholder-white/50 focus:border-[#bb3b3b] focus:outline-none transition-colors resize-none"
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <div
                          className={`absolute top-1 w-4 h-4 bg-[var(--color-text)] rounded-full transition-transform ${
                    ...
                    {[
                      ...
                      <div key={item.key} className="flex items-center justify-between p-4 bg-black/30 rounded-2xl">
                        ...
                        <button
                          ...
                          className={`relative w-12 h-6 rounded-full transition-colors ${
                            settings[item.key as keyof typeof settings] ? "bg-[#bb3b3b]" : "bg-black/30"
                          }`}
                        >
                          <div
              ...
              {activeTab === "gaming" && (
                <motion.div
                  ...
                  className="space-y-6"
                >
                  <h2 className="text-2xl font-bold text-white mb-6">Gaming Preferences</h2>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {platforms.map((platform) => (
                          <button
                            key={platform}
                            onClick={() => {
                              const current = settings.preferredPlatforms;
                              const updated = current.includes(platform)
                                ? current.filter(p => p !== platform)
                                : [...current, platform];
                              handleSettingChange("preferredPlatforms", updated);
                            }}
                            className={`px-4 py-2 rounded-2xl border transition-colors ${
                              settings.preferredPlatforms.includes(platform)
                                ? "bg-[#bb3b3b] border-[#bb3b3b] text-white"
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              const updated = current.includes(genre)
                                ...
                                : [...current, genre];
                              handleSettingChange("favoriteGenres", updated);
                            }}
                            className={`px-4 py-2 rounded-2xl border transition-colors ${
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-black/30 rounded-2xl">
                      ...
                      <select
                        ...
                        className="bg-black/30 border border-white/20 rounded-2xl px-4 py-2 text-white focus:border-[#bb3b3b] focus:outline-none transition-colors"
                      >
